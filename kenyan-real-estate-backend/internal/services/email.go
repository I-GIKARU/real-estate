...
func (s *EmailService) SendVerificationEmail(to, userName, verificationToken string) error {
	...
	data := VerificationEmailData{
		...
		CompanyName:      "Kenyan Real Estate",
...
func (s *EmailService) SendWelcomeEmail(to, userName string) error {
	subject := "Welcome to Kenyan Real Estate!"
...
<body>
    <div class="header">
        <h1>🎉 Welcome to Kenyan Real Estate!</h1>
    </div>
    <div class="content">
        <p>Hello %s,</p>
        ...
        <p>Best regards,<br>The Kenyan Real Estate Team</p>
    </div>
</body>
</html>`, userName)
